            ...
            <div className='shadow-2'>
              <div id='transactions'>
                <Table rowsCount={this.transactions.filtered.length} rowHeight={50} headerHeight={50} width={1130} height={447}>
                  <Column header={<Cell>Date</Cell>} cell={<TableCell data={this.transactions.filtered} column='time' />} width={200} />
                  <Column header={<Cell>Account</Cell>} cell={<TableCell data={this.transactions.filtered} column='account' />} width={200} />
                  <Column header={<Cell>Address</Cell>} cell={<TableCell data={this.transactions.filtered} column='address' />} width={340} />
                  <Column header={<Cell>Category</Cell>} cell={<TableCell data={this.transactions.filtered} column='category' />} width={90} />
                  <Column header={<Cell>Amount</Cell>} cell={<TableCell data={this.transactions.filtered} column='amount' />} width={150} />
                  <Column
